...
# 대시보드용 통합 GLP1 규칙 딕셔너리
GLP1_RULES = {
    "glp1_ndc_prefixes": [p for p in GLP1_NDC_PREFIXES],
    "valid_indications": GLP1_VALID_ICD_PREFIXES,
    "description": "GLP-1 수용체 작용제는 제2형 당뇨(E11) 또는 비만(E66) 진단 시에만 허용",
}
...
# 대시보드용 통합 HCC 규칙 딕셔너리
HCC_RULES = {
    code: {
        "required_icd_patterns": info["expected_icds"],
        "description": info["description"],
        "risk_score_impact": info["risk_score_impact"],
    }
    for code, info in HCC_HIGH_RISK_MAPPINGS.items()
}
